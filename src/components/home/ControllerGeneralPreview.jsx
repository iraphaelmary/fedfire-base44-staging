...
import CGTalk from "../../../src/assets/CG-talk.jpg";
          ...
          >
            ...
            <div className="relative mb-6 md:mb-8">
              ...
              <p className="text-gray-600 text-sm md:text-lg leading-relaxed italic pl-4 md:pl-6">
                "Our commitment to protecting lives and property remains
                unwavering. Through modernization, training, and community
                engagement, we are building a fire service that Nigerians can
            ...
            <div className="space-y-3 md:space-y-4 mb-6 md:mb-8">
              <p className="text-gray-600 text-sm md:text-base leading-relaxed">
                Olumode Adeyemi Samuel is a distinguished fire service
                professional with over three decades of experience. Under his
                leadership, the Federal Fire Service has undergone significant
