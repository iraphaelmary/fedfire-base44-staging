...
// import Bg1 from "../../../src/assets/hero-image.jpg";
...
//     highlight: " Service",
//     desc: "Dedicated to protecting lives and property across Nigeria.",
//     badge: "Federal Republic of Nigeria",
//     bg: Bg1,
//   },
//   {
//     title: "Rapid Emergency",
//     highlight: " Response",
//     desc: "24/7 nationwide response units equipped with modern tools.",
//     badge: "Emergency Operations",
//     bg: Bg1,
//   },
//   {
//     title: "Fire Safety",
//     highlight: " Education",
//     desc: "Community training and awareness programs.",
...
//     title: "Specialized",
//     highlight: " Rescue",
//     desc: "Urban rescue and disaster management services.",
//     badge: "Advanced Rescue Units",
//     bg: Bg1,
//   },
// ];
...
//         <div className="max-w-3xl relative h-[420px]">
//           <AnimatePresence mode="wait">
//             <motion.div
//               key={index}
//               drag="x"
...
//                 <Link
//                   to={createPageUrl("Services")}
//                   className="inline-flex items-center gap-2 bg-[#C41E3A] text-white px-8 py-4 rounded-full font-semibold text-lg hover:bg-[#A01830]"
//                 >
...
//                 <a
//                   href="tel:08032003557"
//                   className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-md text-white px-8 py-4 rounded-full font-semibold text-lg border border-white/20"
//                 >
...
//       <button
//         onClick={prevSlide}
//         className="absolute left-6 top-1/2 -translate-y-1/2 bg-white/10 p-3 rounded-full backdrop-blur-md"
//       >
//         <ChevronLeft className="text-white" />
//       </button>
//       <button
//         onClick={nextSlide}
//         className="absolute right-6 top-1/2 -translate-y-1/2 bg-white/10 p-3 rounded-full backdrop-blur-md"
//       >
...
//             key={i}
//             onClick={() => setIndex(i)}
//             className={`w-3 h-3 rounded-full ${i === index ? "bg-[#D4AF37]" : "bg-white/30"}`}
//           />
//         ))}
//       </div>
//     </section>
...
//     subtitle:
//       "Inspection, risk assessment and enforcement to reduce fire incidents across Nigeria.",
//     bg: Hero1,
//   },
//   {
//     title: "Rescue & Disaster Management",
//     subtitle:
//       "Specialized rescue operations during emergencies and national disasters.",
//     bg: Hero1,
//   },
// ];
...
//         animate={{ opacity: 1, y: 0 }}
//         transition={{ duration: 0.6, delay: 0.5 }}
//         className="absolute bottom-0 left-0 right-0 bg-white/10 backdrop-blur-lg border-t border-white/10 z-10"
//       >
//         <div className="max-w-7xl mx-auto px-4 py-4 md:py-6">
//           <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-8">
//             {[
