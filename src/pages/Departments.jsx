...
const departments = [
  {
    ...
    description:
      "Responsible for all firefighting and emergency response operations across Nigeria. Coordinates deployment of resources and personnel during emergencies.",
    functions: [
  ...
  },
  {
    ...
    description:
      "Oversees all fire prevention activities including inspections, certifications, and public safety campaigns.",
    functions: [
  ...
  },
  {
    ...
    description:
      "Manages all training programs, professional development, and capacity building for fire service personnel.",
    functions: [
  ...
  },
  {
    ...
    description:
      "Investigates fire incidents to determine origin, cause, and circumstances for prevention and legal purposes.",
    functions: [
  ...
  },
  {
    ...
    description:
      "Manages procurement, maintenance, and distribution of firefighting equipment, vehicles, and supplies.",
    functions: [
  ...
  },
  {
    ...
    description:
      "Handles personnel matters including recruitment, welfare, promotions, and staff development.",
    functions: [
  ...
  },
  {
    ...
    description:
      "Manages administrative functions, budgeting, and financial operations of the service.",
    functions: [
      "Budget management",
  ...
  },
  {
    ...
    description:
      "Handles media relations, public communications, and community engagement programs.",
    functions: [
  ...
  },
  {
    ...
    description:
      "Provides medical support to fire service personnel and manages emergency medical response capabilities.",
    functions: [
  ...
  },
  {
    ...
    description:
      "Maintains fire stations, facilities, and infrastructure across the service.",
    functions: [
...
const zoneCommands = [
  ...
  },
  {
    zone: "Zone C",
    headquarters: "Kaduna",
    states: "Kaduna, Kano, Katsina, Jigawa, Zamfara",
  },
  {
    zone: "Zone D",
  ...
  },
  {
    zone: "Zone E",
    headquarters: "Jos",
    states: "Plateau, Nasarawa, Benue, Kogi, Niger",
  },
  {
    zone: "Zone F",
    headquarters: "Port Harcourt",
    states: "Rivers, Bayelsa, Cross River, Akwa Ibom, Delta, Edo",
  },
];
