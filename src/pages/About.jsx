    ...
    <div>
        ...
        <div className="relative max-w-7xl mx-auto px-4">
          ...
          >
            ...
            <p className="text-xl text-gray-300 max-w-2xl">
              Learn about our history, mission, and commitment to protecting Nigeria.
            </p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <span className="text-[#C41E3A] font-semibold text-sm uppercase tracking-wider">Who We Are</span>
              <h2 className="text-3xl md:text-4xl font-bold text-[#1E3A5F] mt-3 mb-6">
                The Federal Fire Service of Nigeria
              </h2>
              <div className="space-y-4 text-gray-600 leading-relaxed">
                <p>
                  The Federal Fire Service (FFS) is a federal government agency established to prevent and combat fires, 
                  provide rescue services, and protect lives and property throughout the Federal Republic of Nigeria.
                </p>
                <p>
                  Operating under the Federal Ministry of Interior, the FFS maintains a presence in all 36 states 
                  and the Federal Capital Territory, with over 150 fire stations strategically located across the nation.
                </p>
                <p>
                  Our dedicated personnel are trained to international standards and equipped with modern firefighting 
                  equipment to respond effectively to fire emergencies, rescue operations, and disaster management situations.
                </p>
              </div>
              <Link
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            >
              ...
              <p className="text-gray-600 leading-relaxed">
                To prevent and combat fires, provide rescue services, and protect lives and property 
                through excellence in fire prevention, firefighting, and emergency response operations 
                across Nigeria, while promoting fire safety awareness among citizens.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-gray-600 leading-relaxed">
                To be a world-class fire service organization, recognized for excellence in fire prevention, 
                firefighting, rescue operations, and disaster management, ensuring the safety and security 
                of lives and property throughout Nigeria.
              </p>
            </motion.div>
          </div>
        </div>
      ...
      <section className="py-20 bg-[#1E3A5F]">
        <div className="max-w-7xl mx-auto px-4">
          ...
          >
            <span className="text-[#D4AF37] font-semibold text-sm uppercase tracking-wider">What Guides Us</span>
        ...
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          >
            ...
            <p className="text-gray-600 text-lg mb-8">
              Learn more about the Controller General and the leadership team driving 
              the Federal Fire Service forward.
            </p>
            <Link
